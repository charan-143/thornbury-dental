...
async function initPGlite(): Promise<any> {
  ...
  await pgliteInstance.exec(`
    ...
    ALTER TABLE appointments ADD COLUMN IF NOT EXISTS room TEXT NOT NULL DEFAULT '';
    ALTER TABLE appointments ADD COLUMN IF NOT EXISTS type TEXT NOT NULL DEFAULT 'General';
    ALTER TABLE appointments ADD COLUMN IF NOT EXISTS status TEXT NOT NULL DEFAULT 'confirmed';

    ALTER TABLE clinicians ADD COLUMN IF NOT EXISTS room TEXT NOT NULL DEFAULT '';
    ALTER TABLE clinicians ADD COLUMN IF NOT EXISTS photo TEXT;
    ALTER TABLE clinicians ADD COLUMN IF NOT EXISTS bio TEXT;
    ALTER TABLE clinicians ADD COLUMN IF NOT EXISTS active BOOLEAN NOT NULL DEFAULT true;
